...
def synthesizer_prompt(
    ...
    return (
        ...
        "  MUST:\n"
        f"  ✓ Name '{company}' explicitly in the first sentence\n"
        "  ✓ Name the 2-3 most important drivers from key_drivers_ranked BY THEIR SPECIFIC CONTENT\n"
        "  ✓ Name the 1-2 most important risks from key_risks_ranked BY THEIR SPECIFIC CONTENT\n"
        "  ✓ Explain the causal chain: [driver/risk] → [effect on business] → [verdict implication]\n"
        "  ✓ Mention at least one of: revenue growth, margins, demand, valuation, competitive position\n"
        "  ✓ Sound like a senior analyst writing for an investment committee\n"
        "  BANNED phrases (using any of these fails the output):\n"
