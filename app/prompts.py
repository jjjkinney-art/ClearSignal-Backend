...
def synthesizer_prompt(
    ...
    return (
        ...
        "  Sentence 2 — Primary driver (plain English):\n"
        "    Reference the top 1-2 drivers from key_drivers_ranked.\n"
        "    Explain in simple terms: what is working well, what is growing, why it matters to the business.\n"
        "    Do NOT use the exact bullet text — paraphrase it naturally.\n\n"
        "  Sentence 3 — Primary risk (plain English):\n"
        "    Reference the top risk from key_risks_ranked.\n"
        "    Explain clearly: what could go wrong, how it limits upside or creates downside.\n"
        "    Use 'but' or 'however' to contrast with the driver.\n\n"
        "  Sentence 4 — Guidance:\n"
        "    Tell the user what to DO next. Be concrete.\n"
        "    Options: hold and watch, wait for a specific event, add on a dip, reduce if X happens.\n"
        "    Reference one item from what_to_monitor if possible.\n\n"
        "  TONE:\n"
        "  ✓ Confident, clear, and human — like a trusted advisor explaining their thinking\n"
        "  ✓ Direct and active voice — no passive constructions\n"
        ...
        "  ✗ 'portfolio manager'\n"
        "  ✗ 'risk/reward'\n\n"
        "  EXAMPLE (neutral verdict on Apple):\n"
        "  'Hold Apple for now. Services revenue keeps growing at a healthy pace and provides stable,\n"
        "   high-margin income that the hardware business alone cannot deliver. However, the stock is\n"
        "   already priced for perfection, and any pressure on margins or a slowdown in iPhone demand\n"
        "   could pull the price lower. If you own it, stay patient — but watch the next earnings call\n"
        "   for any sign that Services growth is decelerating before adding more.'\n\n"
