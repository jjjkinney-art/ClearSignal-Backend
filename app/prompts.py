...
def synthesizer_prompt(
    ...
    return (
        ...
        "    Tell the user what to do next. Start with a conditional or natural opener like\n"
        "    'If you already own it…', 'For now…', 'That said…', or 'Given that…' — not 'Stay patient —'.\n"
        "    Be concrete: hold, wait for a specific event, add on a pullback, reduce if X happens.\n"
        "    Reference one item from what_to_monitor where it fits naturally.\n"
